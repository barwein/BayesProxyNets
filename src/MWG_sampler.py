...
from numpyro.infer import SVI, TraceGraph_ELBO, MCMC, NUTS, Predictive
...
class MWG_init:
    ...
    def init_triu_star_and_exposures(self):
        ...
        exposures_samps = vmap_compute_exposures(triu_star_samps, self.data.Z)
    ...
    def init_outcome_model(self):
        ...
        mcmc_plugin.run(
            self.rng_key, df_nodes, aux.Triu_to_mat(self.triu_star), self.data.Y
        )
